export const MyBackpackSection = ({ myBackpack }: { myBackpack: [string, string[]][] }) => {
  ...
  gold, silver and bronze</b> in IMO,
        some who are going to <b>partcipate in IMO this year</b> representing their country, <b className="max-w-3xl mt-8 text-neutral-800 dark:text-[#14deb9] md:text-[#262627]">MOP qualifiers</b>, <b className="max-w-3xl mt-8 text-neutral-800 dark:text-[#14deb9] md:text-[#14deb9]">USA(J)MO qualifiers</b> and <b className="max-w-3xl mt-8 text-neutral-800 dark:text-[#14deb9] md:text-[#262627]">math enthusisats</b>.
      </p>
