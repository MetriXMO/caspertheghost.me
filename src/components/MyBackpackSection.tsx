export const MyBackpackSection = ({ myBackpack }: { myBackpack: [string, string[]][] }) => {
  ...
  gold, silver and bronze</b> in IMO,
        some who are going to <b>partcipate in IMO this year</b> representing their country, <b className="max-w-3xl mt-8 text-neutral-800 dark:text-[#228cff] md:text-[#228cff]">MOP</b> ers,
        <b className="max-w-3xl mt-8 text-neutral-800 dark:text-[#228cff] md:text-[#228cff]">USA(J)MO qualifiers</b> and <bclassName="max-w-3xl mt-8 text-neutral-800 dark:text-[#228cff] md:text-[#228cff]">math enthusisats</b>.
      </p>
