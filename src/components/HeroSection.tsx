  ...
  return (
    <section className="flex flex-col justify-center mx-auto min-h-[40em]" id="top">
      ...
      <p className="max-w-3xl mt-8 text-neutral-800 dark:text-gray-300 md:text-xl">
        GIMO is an International Mathematical Olympiad style mathematical contest held online for individuals organised by the <b>GIMO team</b> which consists of <b>multiple IMO contestants</b> who have won <b className="max-w-3xl mt-8 text-neutral-800 dark:text-[#14deb9] md:text-[#228cff]">
